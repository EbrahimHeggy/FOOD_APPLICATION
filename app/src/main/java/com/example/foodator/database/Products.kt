...
object Products  {
    ...
    fun fillData( lista : ArrayList<FoodDomain>): ArrayList<FoodDomain>{
        ...
        lista.add(FoodDomain("Burger","Chicken Burger","burger","beef,cheese",10.0,R.drawable.pop_2))
        ...
        lista.add(FoodDomain("Burger","Cheese Burger","mcdonalds_burger_png_high_quality_image_chicken_burger_kfc_png_transparent_png600x600_png_find","slice Chicken  ",20.65,R.drawable.mcdonalds_burger_png_high_quality_image_chicken_burger_kfc_png_transparent_png600x600_png_find))
